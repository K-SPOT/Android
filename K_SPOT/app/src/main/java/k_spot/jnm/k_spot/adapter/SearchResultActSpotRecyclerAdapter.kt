...
class SearchResultActSpotRecyclerAdapter(private var searchSpotItems : ArrayList<PlaceSearchResultData>, private var context: Context, private var ItemCount: Int) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
...
//                .into(holder.category_list_image)
        ...
        holder.result_address.text = searchSpotItems[position]!!.address_gu
